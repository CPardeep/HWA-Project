...
class TestShelterWebsite {
	...
	public void Test_createDogs() throws InterruptedException {
		...
		assertEquals("Name: Roky, Breed: Akita, Age: 1, Colour: #000000, Available: Reserved", website.createDogPage.getOutput().getAttribute("value"));
	}
	...
	public void Test_createShelters() throws InterruptedException {
		...
		// Check for confirmation
		assertEquals("Shelter Name: GG Shelter, Address: 75 Cannock Road, Wolverhampton, Postcode: WV66AS", website.createShelterPage.getOutput().getAttribute("value"));
	}
